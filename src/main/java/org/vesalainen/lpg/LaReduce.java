...
public class LaReduce implements TerminalAction
{
    ...
    public LaReduce(GTerminal symbol, Act act)
    {
        this.symbol = symbol;
        this.act = act;
    }
    ...
    public boolean equals(Object obj)
    {
        ...
        final LaReduce other = (LaReduce) obj;
    ...
    {
        int hash = 7;
        hash = 73 * hash + (this.symbol != null ? this.symbol.hashCode() : 0);
        hash = 73 * hash + (this.act != null ? this.act.hashCode() : 0);
        return hash;
    }
