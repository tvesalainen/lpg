 ...
 */
@GenClassname("org.vesalainen.grammar.BnfParser")
@GrammarDef()
public class BnfGrammar implements GrammarConstants
{
    ...
    protected List<String> parseRhsString(String text, @ParserContext("GRAMMAR") Grammar g)
    {
