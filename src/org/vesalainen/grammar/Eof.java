...
public class Eof extends GTerminal
{
     ...
     * @param terminal 
     */
    Eof(int number, String name, String expression, int priority, boolean whiteSpace, Option... options)
    {
        super(number, "Eof("+name+")", expression, priority, whiteSpace, options);
    }
